...
export const userSessions = pgTable("user_sessions", {
  ...
  userType: text("user_type"), // "reader" or "author"
  maxSectionReached: integer("max_section_reached").notNull().default(0),
...
export const formInteractions = pgTable("form_interactions", {
  id: serial("id").primaryKey(),
  sessionId: text("session_id").notNull(),
  formType: text("form_type").notNull(), // "signup", "partner_contact"
...
export type InsertFormInteraction = typeof formInteractions.$inferInsert;