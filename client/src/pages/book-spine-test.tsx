...
import { BookSpineA, BookSpineB, BookRack, LEAN_OPTIONS } from "@/components/book-spine";
  ...
  return (
    <div className="container py-8">
      ...
      <p className="mb-6 text-muted-foreground">
        This page demonstrates the BookSpine component variants and the BookRack component.
      </p>
      
      <Tabs defaultValue="individual" className="mb-8">
        <TabsList>
          <TabsTrigger value="individual">Individual Spines</TabsTrigger>
          <TabsTrigger value="rack">Book Rack</TabsTrigger>
        </TabsList>
        
        <TabsContent value="individual" className="p-4">
          <h2 className="text-2xl font-bold mb-4">Individual Book Spines</h2>
        ...
        <TabsContent value="rack" className="p-4">
          <h2 className="text-2xl font-bold mb-4">Book Rack</h2>
          <p className="mb-4 text-muted-foreground">
            Displays books on a virtual bookshelf with hover animations and card popups.
          </p>
      ...
      {/* Selected book details - shown when a book is clicked in individual spines mode */}
      {selectedBook && (
